# Курсовая работа 5. Поиск вакансий с подключением БД
...
* data
  * **db_creator.py** файл с SQL-запросами для создания таблиц в БД
  * **.env.example**: файл с настройками подключения к БД (dbname - название БД, user - имя пользователя,
...
* **db_manager.py:** модуль, содержащий определение класса QueryManager. Это менеджер для работы с SQL-запросами.
...
* **utils.py:** этот модуль связывается с базой данных, получает список компаний из файла, создает таблицы в базе данных, 
...
* main.py:«точка входа» — модуль, запустив который можно получить результат всех реализованных в проекте функциональностей.
